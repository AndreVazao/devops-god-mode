...
from app.routes.repo_tree_v13 import router as repo_tree_router
from app.routes.ops_final_candidate import router as ops_router
...
@app.get("/")
def root():
    return {"status": "DevOps God Mode backend alive", "profile": "candidate"}
