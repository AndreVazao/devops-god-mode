...
class RepoTreeActionPlanV2:
    def build_from_snapshot(self, latest_snapshot_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    def build_from_embedded_snapshot(self, repo_full_name: str, snapshot: dict[str, Any]) -> dict[str, Any]:
        payload = {
            "ok": True,
            "repo_full_name": repo_full_name,
            "snapshot": snapshot,
        }
        return self.build_from_snapshot(payload)


repo_tree_action_plan_v2 = RepoTreeActionPlanV2()
