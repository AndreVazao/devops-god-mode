...
class RepoTreeAnalysisV1:
    def analyze(self, tree_json: dict[str, Any]) -> dict[str, Any]:
        ...
        if "prisma/schema.prisma" in lower_names or any(name.endswith("schema.prisma") for name in lower_names):
...
repo_tree_analysis_v1 = RepoTreeAnalysisV1()
