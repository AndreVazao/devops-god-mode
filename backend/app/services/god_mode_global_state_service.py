...
class GodModeGlobalStateService:
    ...
    def operating_model(self) -> Dict[str, Any]:
        return {"primary_brain": {"device": "home_pc", "role": "powerful_backend_runtime", "responsibilities": ["run GodModeDesktop.exe", "open install-use-now", "guide provider setup", "connect APK", "start real usage", "wait for mobile permissions", "reuse vault references"]}, "primary_cockpit": {"device": "android_phone", "role": "mobile apk cockpit", "entrypoint": "/app/mobile-permission-relay", "connection_modes": ["last_working_endpoint", "home_lan_sweep", "remote_https"]}, "pc_cockpit": {"device": "home_pc_browser", "entrypoint": "/app/install-use-now", "guided_setup": "/app/guided-provider-setup", "support": "/app/support-session", "local_url": "http://127.0.0.1:8787/app/home"}}
