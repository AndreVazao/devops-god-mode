...
class GodModeHomeService:
    ...
    def _quick_actions(self) -> List[Dict[str, str]]:
        return [
            {"id": "new_project_start", "label": "Projeto novo", "endpoint": "/api/new-project-start/panel", "priority": "critical"},
            {"id": "approved_work_queue_mobile", "label": "Painel fila", "endpoint": "/api/approved-work-queue-mobile/panel", "priority": "critical"},
            {"id": "approved_work_queue", "label": "Fila aprovada", "endpoint": "/api/approved-work-queue/build", "priority": "critical"},
            {"id": "approved_deep_execution", "label": "Execução aprovada", "endpoint": "/api/approved-deep-execution/plan", "priority": "critical"},
            ...
            {"id": "mobile_result", "label": "Cartão mobile", "endpoint": "/api/mobile-result/home", "priority": "critical"},
            ...
            {"id": "local_ai", "label": "IA local", "endpoint": "/api/local-ai/panel", "priority": "critical"},
