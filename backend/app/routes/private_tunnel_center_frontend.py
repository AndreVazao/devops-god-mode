...
<div class="page">
  ...
  <section class="panel buttons"><button id="refresh">Atualizar</button><button id="copyBase">Copiar URL</button><button id="copyPayload">Copiar payload</button><button id="copyDeepLink">Copiar deep link</button><button onclick="location.href='/app/pairing'" class="dark">Pairing LAN</button></section>
  <section class="grid" id="cards"></section>
  <section class="panel"><h2>QR scannable local</h2><div class="qrbox" id="qrBox"></div><p class="muted">QR gerado localmente a partir de deep link não secreto.</p></section>
  <section class="panel"><h2>Pairing não secreto</h2><div class="grid" id="pairingCards"></div><textarea id="pairingText" readonly></textarea></section>
