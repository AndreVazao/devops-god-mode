...
from app.services.repo_tree_engine import repo_tree_engine
...
async def repo_tree_status():
    return repo_tree_engine.status()
...
async def repo_tree_preview(repo_full_name: str, depth: int = 2):
    ...
    try:
        return await repo_tree_engine.preview(repo_full_name, depth=depth)
