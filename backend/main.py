...
for r in [
    ...
    provider_deploy_execution_router, provider_secret_sync_router, remote_brain_linkage_router,
    ...
    chat_inventory_router, repo_env_harvest_router, script_reuse_router,
