...
for r in [
    ...
    delivery_history_router, deployment_secret_binding_router, final_summary_router,
    remote_brain_linkage_router, remote_channel_stability_router, remote_session_persistence_router,
